  ...
  return (
    ...
    >
      ...
      <div className="w-full text-center font-inter font-bold italic text-2xl text-white flex justify-center items-center">
        Share Quiz &<br></br> Get Free Gifts!
      </div>
      ...
      <div className="w-full relative flex flex-col justify-center items-center">
        <Image
          alt="surprise"
          src="/SPECIAL PRIZES/PRIZES_group.png"
          width={317}
          height={473}
        ></Image>
      ...
      <div className="w-full flex justify-center items-center">
        <button
          ...
          className="p-3 w-1/2 text-center mt-8 rounded-lg shadow-lg text-white font-bold bg-gradient-to-r from-[#FAA98F] to-[#FD67AD]"
        >
          Go to Result
        </button>
      </div>
