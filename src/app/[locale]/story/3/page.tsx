            ...
            <div className="absolute inset-0">
                <div className="relative w-full flex justify-center items-center flex-col">
                    ...
                    <div className="relative mt-10 w-full flex flex-col justify-center items-center bg-transparent">
                        ...
                        { !finish && (
                            <>
                                <div className="pb-20 font-bold gap-1 mt-16 z-10 flex flex-col justify-start items-start px-10 w-[350px]">
                                    <div className="gap-1 inline-flex justify-center items-center text-black ">
                                        Nickname*:
                                        <input
                                            required
                                            type="text"
                                            ...
                                            className="outline-none border-b-2 border-black bg-transparent max-w-40"
                                        />
                                    </div>
                                    ...
                                    <div className="gap-1 inline-flex justify-center items-center text-black ">
                                        ...
                                        <select
                                            ...
                                            className="outline-none border-2 rounded-lg border-black bg-transparent max-w-40"
                                        >
                                ...
                                <div className="h-6 mt-7 flex flex-col justify-center items-center gap-y-3">
                                        <button disabled={nickname === "" || age === "" || mail === "" || !acceptConditions} onClick={onSubmitForm} className="text-white py-2.5 shadow-lg rounded-lg text-center font-bold w-full mx-24 transition-all duration-50 ease-in-out disabled:opacity-50 bg-gradient-to-r from-[#FAA98F] to-[#FD67AD]">
                                            Done!
                                        </button>
                        ...
                        { finish && (
                            <div className="text-4xl mt-32 h-full font-bold z-10 flex justify-center items-center">
                                DONE!
                            </div>
                        )}
                    </div>
