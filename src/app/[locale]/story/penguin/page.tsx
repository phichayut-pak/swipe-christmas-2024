...
const PenguinPage = () => {
  ...
  const [backgroundImage, setBackgroundImage] = useState(
    "url('/STORY 5-7/PENGUIN_WITH_BG.png')"
  );
      ...
      <div className="w-full h-auto flex justify-center items-center relative">
        ...
        {level === 1 && (
          <div className="absolute mb-16 flex flex-col justify-center items-center gap-6 text-2xl font-bold text-center text-black">
            ...
            <button
              onClick={() => setLevel(2)}
              className="shadow-lg text-center text-white text-xl rounded-lg py-2 px-8 bg-gradient-to-r from-[#FAA98F] to-[#FD67AD]"
            >
              Next
            </button>
          </div>
        ...
        {level === 2 && (
          <div className="absolute mb-16 flex flex-col justify-center items-center gap-3 text-2xl font-bold text-center text-black">
            Are you ready to explore?
            {choice === "" && (
              <div className="flex flex-col justify-center items-center gap-y-2">
                <button
                  onClick={() => handleChoiceChange("yes")}
                  className="shadow-lg text-center text-white text-xl rounded-lg py-2 px-12 bg-gradient-to-r from-[#FAA98F] to-[#FD67AD]"
                >
                  Yes
                </button>
                ...
                <button
                  ...
                  className="shadow-lg text-center text-white text-xl rounded-lg py-2 px-12 bg-black"
                >
                  No
                </button>
              </div>
            ...
            {choice === "yes" && (
              <button
                ...
                className="shadow-lg text-center text-white text-2xl rounded-lg py-2 px-20 bg-gradient-to-r from-[#39D68E] to-[#29A85F]"
              >
                Yes!
              </button>
            )}
